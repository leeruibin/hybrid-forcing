...
class BidirectionalDiffusionInferencePipeline(torch.nn.Module):
    def __init__(
        ...
        self.text_encoder = WanTextEncoder(args.model_path) if text_encoder is None else text_encoder
        self.vae = WanVAEWrapper(args.model_path) if vae is None else vae
