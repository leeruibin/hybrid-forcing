# Runbook: torchrun --nproc-per-node 8 train.py --config_path configs/rolling_forcing_dmd.yaml --logdir logs/rolling_forcing_dmd --sp_size 2
import argparse
import os
...
def main():
    ...
    parser.add_argument("--sp_size", type=int, default=1, help="Size of the spatial parallelism")
